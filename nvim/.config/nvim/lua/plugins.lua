...
return require('packer').startup(function(use)
    ...
    use 'bling/vim-bufferline' -- To see buffers/tabs in bottom airline bar
    ...
    use { -- TreeSitter for syntax highlighting and code `understanding`
    ...
    -- use 'tpope/vim-commentary' -- Comments gc
